...
class ParametersControllerTest < ActionController::TestCase
  ...
  test "should create parameter" do
    assert_difference('Parameter.count') do
      post :create, parameter: { key: @parameter.key, rr_id: @parameter.rr_id, type: @parameter.type, value: @parameter.value }
    end
  ...
  test "should update parameter" do
    put :update, id: @parameter, parameter: { key: @parameter.key, rr_id: @parameter.rr_id, type: @parameter.type, value: @parameter.value }
    assert_redirected_to parameter_path(assigns(:parameter))
  end
